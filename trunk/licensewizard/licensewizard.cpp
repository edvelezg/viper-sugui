    ...
    : QWizardPage(parent)
{
    ...
    topLabel = new QLabel(tr("Este wizard le ayudara a agregar su "
                             "<i>Modelo de Velocidad</i> a la lista "
                             "de modelos de velocidad."));
    topLabel->setWordWrap(true);

    registerRadioButton = new QRadioButton(tr("&Agregar Modelo de Velocidad existente"));
	evaluateRadioButton = new QRadioButton(tr("&Crear Modelo de Velocidad"));
...
RegisterPage::RegisterPage(QWidget *parent)
    : QWizardPage(parent)
{
    setTitle(tr("Agregar <i>Modelo de Velocidad</i>&trade;"));
    setSubTitle(tr("Escoja una de las siguientes opciones, "
                   "para agregar el su modelo de velocidad a la lista."));

    nameLabel = new QLabel(tr("N&ombre:"));
    nameLineEdit = new QLineEdit;
    nameLabel->setBuddy(nameLineEdit);
